  ...
  <div style="display: contents">
    <div class="content-header-container">
      <div class="header-text">
        ...
        <span class="primary-text">&nbsp;{{ scoreValue }}</span>
      </div>
    </div>

    <div class="inner-content-container" v-if="borrowerScores.length">
      <div class="score-main">
                ...
                >
                  <template #content>
                    <div
                      ...
                      :style="{ transform: index === 1 ? 'scale(1)' : 'scale(0.7)' }"
                    >
        ...
        <v-row class="py-0 w-100" v-if="coBorrowerScores.length">
          <v-col cols="12" class="text-center mt-5 mb-sm-0 mb-5">
            <div class="title">
              Credit Scores for: {{ `${coBorrower?.FirstName} ${coBorrower?.LastName}` }}
            </div>
          </v-col>
        </v-row>
        <v-row
