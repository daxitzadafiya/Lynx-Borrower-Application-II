...
const priorPropertyDeedInLieuConveyedIndicatorValue = computed(() => {
  if (props.declarations.PriorPropertyDeedInLieuConveyedIndicator === null) {
    return null;
  } else {
    return props.declarations.PriorPropertyDeedInLieuConveyedIndicator;
  }
});
</script>
<template>
