...
const presentlyDelinquentIndicatorValue = computed(() => {
  if (props.declarations.PresentlyDelinquentIndicator === null) {
    return null;
  } else {
    return props.declarations.PresentlyDelinquentIndicator;
  }
});
</script>
<template>
