...
const undisclosedComakerOfNoteIndicatorValue = computed(() => {
  if (props.declarations.UndisclosedComakerOfNoteIndicator === null) {
    return null;
  } else {
    return props.declarations.UndisclosedComakerOfNoteIndicator;
  }
});
</script>
<template>
  <div class="content-container image-content-type">
    <div class="image-container">
      <div class="titleText">
        Are you a co-signer or guarantor on any debt or loan that is not disclosed on this
        application?
      </div>
      <Declarations_8 />
      <v-form class="my-5">
